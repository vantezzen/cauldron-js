...
if (!window.localStorage.debug) {
  window.localStorage.setItem('debug', 'cauldron:*')
...
if (window.localStorage.getItem('setting.version')) {
  ...
  const generator = window.localStorage.getItem('setting.generator')
  const seed = window.localStorage.getItem('setting.seed')
...
document.getElementById('start').addEventListener('click', () => {
  ...
  // Save settings in window.localStorage
  window.localStorage.setItem('setting.version', version)
  window.localStorage.setItem('setting.motd', motd)
  window.localStorage.setItem('setting.generator', generator)
  window.localStorage.setItem('setting.seed', seed)
...
document.getElementById('stop').addEventListener('click', () => {
  ...
  document.getElementById('version').value = window.localStorage.getItem('setting.version')
  document.getElementById('motd').value = window.localStorage.getItem('setting.motd')
  document.getElementById('generator').value = window.localStorage.getItem('setting.generator')
  document.getElementById('seed').value = window.localStorage.getItem('setting.seed')
...
document.getElementById('delete').addEventListener('click', () => {
  ...
  // Delete all data
  window.indexedDB.deleteDatabase('world')
  window.indexedDB.deleteDatabase('Minecraft')
